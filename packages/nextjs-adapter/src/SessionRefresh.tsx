...
interface SessionRefreshProps {
  /**
   * Server action that refreshes the session.
   * Create this in your app using `createRefreshSessionAction` from this package.
   *
   * @example
   * ```typescript
   ...
   * import { createRefreshSessionAction } from '@kenmon/nextjs-adapter'
 ...
 *     <html>
 *       <body>
 *         <SessionRefresh refreshAction={refreshSession} refreshInterval={86400} />
 *         {children}
 *       </body>
 *     </html>
 *   )
